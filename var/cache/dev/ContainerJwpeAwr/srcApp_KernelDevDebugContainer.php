...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/limenius/react-renderer/src/Limenius/ReactRenderer/Twig/ReactRenderExtension.php';
            include_once $this->targetDirs[3].'/vendor/limenius/react-renderer/src/Limenius/ReactRenderer/Renderer/AbstractReactRenderer.php';
            include_once $this->targetDirs[3].'/vendor/limenius/react-renderer/src/Limenius/ReactRenderer/Renderer/PhpExecJsReactRenderer.php';
            include_once $this->targetDirs[3].'/vendor/limenius/react-renderer/src/Limenius/ReactRenderer/Context/ContextProviderInterface.php';
            include_once $this->targetDirs[3].'/vendor/limenius/react-renderer/src/Limenius/ReactRenderer/Context/SymfonyContextProvider.php';
            include_once $this->targetDirs[3].'/vendor/limenius/react-renderer/src/Limenius/ReactRenderer/Renderer/StaticReactRenderer.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MRKoeIi3QS', 0, ($this->targetDirs[0].'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('i9CgLdpJvG', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getTwigService()
    {
        ...
        $f = new \Limenius\ReactRenderer\Context\SymfonyContextProvider($d);
        ...
        $instance->addExtension(new \Limenius\ReactRenderer\Twig\ReactRenderExtension(new \Limenius\ReactRenderer\Renderer\PhpExecJsReactRenderer(($this->targetDirs[3].'/src/Resources/webpack/server-bundle.js'), false, $f, ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService())), new \Limenius\ReactRenderer\Renderer\StaticReactRenderer(), $f, 'both', false));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('28qGsVrjsF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rDtcKcqLRA', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4U3YDQcbDi', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('h34WsgLfkN', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PAgizXsQUO', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'limenius_react.static_react_renderer.class' => 'Limenius\\ReactRenderer\\Renderer\\StaticReactRenderer',
